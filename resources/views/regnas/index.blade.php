          ...
          <div class="col-sm-12">
              <div class="card">
                  <div class="card-header">
                      <div class="row">
                          <div class="col-sm-12">
                              <h2>DAFTAR REGULASI NASIONAL</h2>
                          </div>
                      </div>
                  </div>
              </div>
        ...
        <div class="col-sm-12">
          <div class="card table-card">
            <div class="row">
              ...
              <div class="col-sm-6">
                <div class="card-header">
                  <form action="{{ route('regnas.index') }}" method="get">
                    <div class="row">
                      <div class="col-sm-10">
                  ...
                  <tr>
                    ...
                    <td>
                        <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                          <a href="{{ route('regnas.detail', $data->id) }}" class="btn btn-info" title="detail"><i class="ph ph-clipboard"></i></a>
        ...
        <div class="modal-dialog">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form action="{{ route('regnas.tambah') }}" method="post" enctype="multipart/form-data"   >
                @csrf
                <div class="col-sm">
...
<script src="https://code.jquery.com/jquery-3.6.4.slim.js" integrity="sha256-dWvV84T6BhzO4vG6gWhsWVKVoa4lVmLnpBOZh/CAHU4=" crossorigin="anonymous"></script>
      <script>
        ...
        .then((willDelete) => {
        if (willDelete) {
            window.location = "/regulasinasional/hapus/"+id+""

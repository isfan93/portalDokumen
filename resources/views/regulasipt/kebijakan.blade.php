        ...
        <div class="col-sm-12">
          <div class="card table-card">
            <div class="row">
              ...
              <div class="col-sm-6">
                <div class="card-header">
                  <form action="{{ route('regulasi.kebijakan') }}" method="get">
                    <div class="row">
                      <div class="col-sm-10">
                  ...
                  <tr>
                    ...
                    <td>
                        <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                          <a href="{{ route('regulasi.detailkb', $data->id) }}" class="btn btn-info" title="detail"><i class="ph ph-clipboard"></i></a>
        ...
        <div class="modal-dialog">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form action="{{ route('regulasi.tambahDataKebijakan') }}" method="post" enctype="multipart/form-data"   >
                @csrf
                <div class="col-sm">
